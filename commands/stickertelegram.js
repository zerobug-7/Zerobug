...
async function stickerTelegramCommand(sock, chatId, msg) {
    try {
        ...
        try {
            ...
            await sock.sendMessage(chatId, { 
                text: `📦 *𝖿᥆ᥙᥒძ ${stickerSet.result.stickers.length} s𝗍іᥴkᥱrs*\n*⏳ s𝗍ᥲr𝗍іᥒg ძ᥆ᥕᥒᥣ᥆ᥲძ*...` 
            });
            ...
            await sock.sendMessage(chatId, { 
                text: `✅ *sᥙᥴᥴᥱss𝖿ᥙᥣᥣᥡ ძ᥆ᥕᥒᥣ᥆ᥲძᥱძ ${successCount}/${stickerSet.result.stickers.length} s𝗍іᥴkᥱrs*!` 
            });
